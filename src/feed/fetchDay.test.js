...
const mockDay = {
  ...
  hdurl:
    "https://apod.nasa.gov/apod/image/2110/MonumentValleyRoad_Abramyan_2048.jpg",
  media_type: "image",
  service_version: "v1",
...
describe("fetchDay", () => {
  it("should fetch APOD data for the specified day", async () => {
    const fetchData = await fetchDay("2021-10-25");
    expect(fetchData).toMatchObject(mockDay);
  });
});
